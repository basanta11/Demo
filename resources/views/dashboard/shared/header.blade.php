    ...
    <div class="c-wrapper">
      <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
        ...
        <button class="c-header-toggler c-class-toggler ml-3 d-md-down-none" type="button"  data-class="c-sidebar-minimized" responsive="true"><span class="c-header-toggler-icon"></span></button>
